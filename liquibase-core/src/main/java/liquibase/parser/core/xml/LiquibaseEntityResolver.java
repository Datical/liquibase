...
public class LiquibaseEntityResolver implements EntityResolver2 {
    ...
    public InputSource resolveEntity(String name, String publicId, String baseURI, String systemId) throws SAXException, IOException {
        ...
        CompositeResourceAccessor compositeResourceAccessor = new CompositeResourceAccessor(currentScopeResourceAccessor, classLoaderResourceAccessor);
        InputStreamList streams = compositeResourceAccessor.openStreams(null, path);
        if (streams.isEmpty()) {
