...
class StringUtilsTest extends Specification {
    ...
    def "processMultilineSql examples"() {
        expect:
        that Arrays.asList(StringUtils.processMultiLineSQL(rawString, stripComments, splitStatements, endDelimiter)), Matchers.contains(expected.toArray())
        ...
        true          | true            | "\\nGO"      | "CREATE OR REPLACE PACKAGE emp_actions AS  -- spec\nTYPE EmpRecTyp IS RECORD (emp_id INT, salary REAL);\nCURSOR desc_salary RETURN EmpRecTyp);\nEND emp_actions;\nGO\nanother statement;here\nGO\n"                              | ["CREATE OR REPLACE PACKAGE emp_actions AS  \nTYPE EmpRecTyp IS RECORD (emp_id INT, salary REAL);\nCURSOR desc_salary RETURN EmpRecTyp);\nEND emp_actions;", "another statement;here"]
        true          | true            | null         | "CREATE TABLE DEPT (\n    DEPTNO   CHAR(3)     NOT NULL,\n    DEPTNAME VARCHAR(36) NOT NULL,\n    PRIMARY KEY(DEPTNO)\n );\n --Template015 End"                                                                                  | ["CREATE TABLE DEPT (\n    DEPTNO   CHAR(3)     NOT NULL,\n    DEPTNAME VARCHAR(36) NOT NULL,\n    PRIMARY KEY(DEPTNO)\n )"]
        true          | false           | null         | "CREATE TABLE DEPT (\n    DEPTNO   CHAR(3)     NOT NULL,\n    DEPTNAME VARCHAR(36) NOT NULL,\n    PRIMARY KEY(DEPTNO)\n );\n --Template015 End"                                                                                  | ["CREATE TABLE DEPT (\n    DEPTNO   CHAR(3)     NOT NULL,\n    DEPTNAME VARCHAR(36) NOT NULL,\n    PRIMARY KEY(DEPTNO)\n );"]
        false         | true            | null         | "CREATE TABLE DEPT (\n    DEPTNO   CHAR(3)     NOT NULL,\n    DEPTNAME VARCHAR(36) NOT NULL,\n    PRIMARY KEY(DEPTNO)\n );\n --Template015 End"                                                                                  | ["CREATE TABLE DEPT (\n    DEPTNO   CHAR(3)     NOT NULL,\n    DEPTNAME VARCHAR(36) NOT NULL,\n    PRIMARY KEY(DEPTNO)\n )\n --Template015 End"]
        false         | false           | null         | "CREATE TABLE DEPT (\n    DEPTNO   CHAR(3)     NOT NULL,\n    DEPTNAME VARCHAR(36) NOT NULL,\n    PRIMARY KEY(DEPTNO)\n );\n --Template015 End"                                                                                  | ["CREATE TABLE DEPT (\n    DEPTNO   CHAR(3)     NOT NULL,\n    DEPTNAME VARCHAR(36) NOT NULL,\n    PRIMARY KEY(DEPTNO)\n );\n --Template015 End"]
        true          | true            | null         | "CREATE TABLE DEPT (\n    DEPTNO   CHAR(3)     NOT NULL,\n    DEPTNAME VARCHAR(36) NOT NULL,\n    PRIMARY KEY(DEPTNO)\n );\n\n INSERT INTO DEPT VALUES ('abc', 'test1', 'abcdef', 'abc', 'test');\n --Template015 End"           | ["CREATE TABLE DEPT (\n    DEPTNO   CHAR(3)     NOT NULL,\n    DEPTNAME VARCHAR(36) NOT NULL,\n    PRIMARY KEY(DEPTNO)\n )", "INSERT INTO DEPT VALUES ('abc', 'test1', 'abcdef', 'abc', 'test')"]
        true          | false           | null         | "CREATE TABLE DEPT (\n    DEPTNO   CHAR(3)     NOT NULL,\n    DEPTNAME VARCHAR(36) NOT NULL,\n    PRIMARY KEY(DEPTNO)\n );\n\n INSERT INTO DEPT VALUES ('abc', 'test1', 'abcdef', 'abc', 'test');\n --Template015 End"           | ["CREATE TABLE DEPT (\n    DEPTNO   CHAR(3)     NOT NULL,\n    DEPTNAME VARCHAR(36) NOT NULL,\n    PRIMARY KEY(DEPTNO)\n );\n\n INSERT INTO DEPT VALUES ('abc', 'test1', 'abcdef', 'abc', 'test');"]
        false         | true            | null         | "CREATE TABLE DEPT (\n    DEPTNO   CHAR(3)     NOT NULL,\n    DEPTNAME VARCHAR(36) NOT NULL,\n    PRIMARY KEY(DEPTNO)\n );\n\n INSERT INTO DEPT VALUES ('abc', 'test1', 'abcdef', 'abc', 'test');\n --Template015 End"           | ["CREATE TABLE DEPT (\n    DEPTNO   CHAR(3)     NOT NULL,\n    DEPTNAME VARCHAR(36) NOT NULL,\n    PRIMARY KEY(DEPTNO)\n )", "INSERT INTO DEPT VALUES ('abc', 'test1', 'abcdef', 'abc', 'test')\n --Template015 End"]
        false         | false           | null         | "CREATE TABLE DEPT (\n    DEPTNO   CHAR(3)     NOT NULL,\n    DEPTNAME VARCHAR(36) NOT NULL,\n    PRIMARY KEY(DEPTNO)\n );\n\n INSERT INTO DEPT VALUES ('abc', 'test1', 'abcdef', 'abc', 'test');\n --Template015 End"           | ["CREATE TABLE DEPT (\n    DEPTNO   CHAR(3)     NOT NULL,\n    DEPTNAME VARCHAR(36) NOT NULL,\n    PRIMARY KEY(DEPTNO)\n );\n\n INSERT INTO DEPT VALUES ('abc', 'test1', 'abcdef', 'abc', 'test');\n --Template015 End"]
    ...
    @Unroll
    def "getWhiteSpaceSymbolBeforeLastComment examples"() {
        expect:
        StringClauses clauses = new StringClauses()
        for (StringClauses.LiteralClause stringClause : stringClauses) {
            clauses.append(stringClause)
        }

        StringUtils.getWhiteSpaceSymbolBeforeLastComment(clauses, defaultSeparator) == expectedDelimiter

        where:
        stringClauses                                                                                                                                                               | defaultSeparator | expectedDelimiter
        []                                                                                                                                                                          | " "              | " "
        [new StringClauses.Comment("-- SQL Comment")]                                                                                                                               | " "              | " "
        [new StringClauses.Comment("-- SQL Comment"), new StringClauses.Whitespace("  \n")]                                                                                         | " "              | " "
        [new StringClauses.Whitespace("  \n"), new StringClauses.Comment("-- SQL Comment"), new StringClauses.Whitespace("  \n")]                                                   | " "              | "  \n"
        [new StringClauses.Whitespace("  \n"), new StringClauses.Comment("-- SQL Comment"), new StringClauses.Whitespace("\t"), new StringClauses.Comment("-- Latest SQL Comment")] | " "              | "\t"
        [new StringClauses.Delimiter(";"), new StringClauses.Comment("-- SQL Comment")]                                                                                             | " "              | " "
    }
